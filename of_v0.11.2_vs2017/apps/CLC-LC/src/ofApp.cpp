...
void ofApp::setup(){
	...
	showElements.push_back(new RealtimeAudioShowElement("SuperEllipse-1", "Microphone (Realtek(R) Audio)", new SuperEllipseSet(4, 100, 100)));
	showElements.push_back(new RealtimeAudioShowElement("VerticalLines-1", "Microphone (Realtek(R) Audio)", new LineSet()));
	showElements.push_back(new RealtimeAudioShowElement("HorizontalLines-1", "Microphone (Realtek(R) Audio)", new HorizontalLineSet()));
